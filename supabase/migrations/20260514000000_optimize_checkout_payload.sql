-- Optimize process_checkout: resolve drug name server-side
-- Date: 2026-05-14
-- Purpose: Reduce frontend payload size by removing 'name', 'dosageForm', etc.
--          The server now builds the full display name from the drugs table.
...
BEGIN
    ...
    LOOP
        ...
        -- Record Sale Item (use server-resolved name)
        ...
        LOOP
            ...
            -- Record Stock Movement with server-resolved name
