-- ============================================================
-- Fix process_return to handle visa returns so they
-- are recorded in the shift transactions and update card_sales
-- ============================================================
...
BEGIN
    ...
    IF v_shift_id IS NOT NULL THEN
        ...
        ELSIF v_payment_method = 'visa' THEN
            ...
            PERFORM atomic_increment_shift(v_shift_id, 0, 0, 0, -v_running_total_refund, 0, 0, 0);
        END IF;
    END IF;
