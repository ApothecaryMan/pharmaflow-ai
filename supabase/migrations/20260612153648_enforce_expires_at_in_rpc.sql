-- ═══════════════════════════════════════════
-- Migration: Enforce expires_at in Employment Request Acceptance
-- Prevents acceptance of requests where expires_at is past the current time
-- ═══════════════════════════════════════════
