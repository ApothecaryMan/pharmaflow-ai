-- ==========================================
-- Migration: Restore Cash Transactions to process_checkout
-- Description:
--   - Restores the INSERT INTO cash_transactions and PERFORM atomic_increment_shift
--   - Preserves the address logic added in 20260630000000_add_address_to_checkout.sql
-- ==========================================
