...
- TypeScript (ES2022), React 19+ + Supabase (Auth & Postgres), Vite, Tailwind CSS (019-employee-portal)
...
## Recent Changes
- 019-employee-portal: Added TypeScript (ES2022), React 19+ + Supabase (Auth & Postgres), Vite, Tailwind CSS
