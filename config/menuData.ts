  ...
  },
  {
    ...
    submenus: [
      ...
      },
      {
        ...
        items: [
          {
            label: 'Sales by Product Analysis',
            view: 'intelligence',
            icon: 'auto_graph',
            permission: 'reports.view_financial',
          },
          {
            label: 'Login Audit Report',
            view: 'login-audit',
            icon: 'history',
            permission: 'reports.view_financial',
          },
    ...
    submenus: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Print Settings', view: 'browser-settings', icon: 'print' },
        ],
      },
      {
        id: 'system-settings',
    ...
    submenus: [
      {
        ...
        items: [
          {
            label: 'Dashboard Experiments',
            view: 'dashboard-experiments',
            icon: 'dashboard_customize',
          },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Animated Counter Lab', view: 'animated-counter-lab', icon: 'text_format' },
          { label: 'Scrollbar Lab', view: 'scrollbar-lab', icon: 'science' },
          { label: 'Animation Lab', view: 'animation-lab', icon: 'animation' },
          { label: 'A5 Invoice Lab', view: 'a5-invoice-designer', icon: 'print' },
          { label: 'Filter Dropdown Test', view: 'filter-dropdown-test', icon: 'filter_alt' },
        ],
      },
    ],
  },
