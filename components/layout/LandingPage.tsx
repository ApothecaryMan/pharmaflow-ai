    ...
    <div className='flex flex-col items-center text-center max-w-2xl relative z-10'>
      ...
      <div className='space-y-6 mb-10'>
        <div className='flex items-center justify-center gap-6'>
          ...
          <h1 className='text-7xl font-bold text-zinc-900 dark:text-zinc-50 tracking-tighter uppercase'>
            ZINC
          </h1>
          <div className='h-px w-12 bg-zinc-200 dark:bg-zinc-800' />
        </div>
        ...
        <div className='space-y-3'>
          <p
            className={`text-[11px] font-bold text-zinc-500 dark:text-zinc-400 ${language === 'EN' ? 'uppercase tracking-[0.6em] pl-[0.6em]' : ''}`}
          >
