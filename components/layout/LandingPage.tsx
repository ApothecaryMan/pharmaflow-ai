  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center p-8 animate-fade-in select-none">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute -top-24 -right-24 w-96 h-96 bg-${color}-500/5 rounded-full blur-3xl`}></div>
        <div className={`absolute -bottom-24 -left-24 w-96 h-96 bg-${color}-500/5 rounded-full blur-3xl`}></div>
      </div>
      ...
      <div className="relative flex flex-col items-center text-center max-w-2xl">
        ...
        <div className="mb-12 relative group">
          {/* Glowing Aura */}
          <div className={`absolute inset-0 bg-${color}-500/20 blur-2xl rounded-full scale-150 opacity-0 group-hover:opacity-100 transition-all duration-1000`}></div>
