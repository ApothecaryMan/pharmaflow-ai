...
export const KPIGridSkeleton = () => (
  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
    {[1, 2, 3, 4].map((i) => (
      <div key={i} className='h-24 bg-gray-100 dark:bg-neutral-800/50 rounded-xl animate-pulse' />
    ))}
  </div>
);

export const TopBarSkeleton = () => (
  <div className='h-16 bg-gray-100 dark:bg-neutral-800/50 rounded-xl animate-pulse w-full' />
);

export const MainContentSkeleton = () => (
  <div className='h-64 md:h-96 bg-gray-100 dark:bg-neutral-800/50 rounded-xl animate-pulse flex-1 w-full' />
);
