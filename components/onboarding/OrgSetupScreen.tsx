  ...
  const plans = [
    {
      ...
      desc: isRTL ? 'فرع واحد، ٣ موظفين' : '1 Branch, 3 Employees',
      icon: 'person',
    },
    {
      id: 'starter',
      name: isRTL ? 'بداية' : 'Starter',
      desc: isRTL ? 'فرع واحد، ١٠ موظفين' : '1 Branch, 10 Employees',
      icon: 'storefront',
      badge: isRTL ? 'الأكثر طلباً' : 'Recommended',
    },
    {
      id: 'pro',
      name: isRTL ? 'احترافي' : 'Pro',
      desc: isRTL ? '٥ فروع، ٢٠ موظف' : '5 Branches, 20 Employees',
      icon: 'hub',
    },
  ];
              ...
              {plans.map((plan) => (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: selectedPlan === plan.id ? selectedTheme.hex : undefined,
                    }}
                  >
