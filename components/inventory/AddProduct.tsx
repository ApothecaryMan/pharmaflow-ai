...
export const AddProduct: React.FC<AddProductProps> = ({
  ...
  const isRTL =
    t.direction === 'rtl' ||
    t.lang === 'ar' ||
    (t.addProduct && /[\u0600-\u06FF]/.test(t.addProduct.title || ''));
  ...
  const genericNameDir = useSmartDirection(
    formData.genericName || '',
    t.addProduct.placeholders.genericName
  );
  const descriptionDir = useSmartDirection(
    formData.description || '',
    t.addProduct.placeholders.description
  );
  const internalCodeDir = useSmartDirection(
    formData.internalCode || '',
    t.addProduct.placeholders.internalCode
  );
        ...
        <form onSubmit={(e) => handleSubmit(e, false)} className='p-6 md:p-8 space-y-8'>
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div className='space-y-2'>
                <label className='text-xs font-bold text-gray-500 uppercase'>
                  {t.addProduct.fields.genericName} *
                </label>
                <input
                  required
                  className='w-full p-3 rounded-xl bg-gray-50 dark:bg-gray-800 border-none focus:ring-2 focus:ring-inset transition-all'
              ...
              <div className='space-y-2 md:col-span-1'>
                <label className='text-xs font-bold text-gray-500 uppercase'>
                  {t.addProduct.fields.dosageForm || 'Product Type'}
                </label>
                <FilterDropdown
                  variant='input'
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div className='space-y-2'>
                <label className='text-xs font-bold text-gray-500 uppercase'>
                  {t.addProduct.fields.internalCode}
                </label>
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              ...
              <div className='space-y-2'>
                <label className='text-xs font-bold text-gray-500 uppercase'>
                  {t.addProduct.fields.unitsPerPack}
                </label>
                <input
                  type='number'
                  min='1'
              ...
              <div className='space-y-2'>
                <label className='text-xs font-bold text-gray-500 uppercase'>
                  {t.addProduct.fields.expiryDate} *
                </label>
                <input
                  type='date'
                  required
          ...
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              <div className='space-y-2'>
                <label className='text-xs font-bold text-gray-500 uppercase'>
                  {t.addProduct.fields.sellingPrice} *
                </label>
                <input
                  type='number'
                  step='0.01'
              ...
              <div className='space-y-2'>
                <label className='text-xs font-bold text-gray-500 uppercase'>
                  {t.addProduct.fields.maxDiscount}
                </label>
                <input
                  type='number'
                  min='0'
