                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6">
                    {!selectedElementId ? (
                        <>
                            ...
                            {/* Print Offset Calibration - Material 3 Expressive */}
                            <div className={`p-4 bg-${color}-50/50 dark:bg-${color}-950/20 rounded-2xl border border-${color}-100 dark:border-${color}-900/30`}>
                                <div className="flex items-center gap-2 mb-4">
                                    <div className={`w-8 h-8 rounded-xl bg-${color}-100 dark:bg-${color}-900/40 flex items-center justify-center`}>
                                        <span className={`material-symbols-rounded text-lg text-${color}-600 dark:text-${color}-400`}>tune</span>
                                    </div>
                                    <div>
                                        <h4 className={`text-sm font-bold text-${color}-900 dark:text-${color}-100`}>{t.printSettings.printCalibration}</h4>
                                    </div>
                                </div>
                                ...
                                <button 
                                    ...
                                    className={`w-full mt-4 py-2 rounded-xl text-xs font-medium transition-all flex items-center justify-center gap-1.5 ${
