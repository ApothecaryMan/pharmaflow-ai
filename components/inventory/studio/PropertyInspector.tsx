    ...
    <div className={`w-full lg:w-80 ${CARD_BASE} rounded-3xl flex flex-col overflow-hidden`}>
      ...
      >
        <div className='flex items-center gap-2'>
          ...
          <h3
            className={`font-bold text-[10px] uppercase tracking-[0.2em] text-gray-500 dark:text-gray-400`}
          >
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span className='text-xs font-medium text-gray-600 dark:text-gray-300'>
                        {t.printSettings.horizontalOffset}
                      </span>
                    </div>
                    <span
                ...
                <div className='space-y-2'>
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span className='text-xs font-medium text-gray-600 dark:text-gray-300'>
                        {t.printSettings.verticalOffset}
                      </span>
                    </div>
                    <span
                      className={`text-xs font-bold px-2 py-0.5 rounded-full bg-${color}-100 dark:bg-${color}-900/40 text-${color}-700 dark:text-${color}-300`}
                  ...
                  <div className='p-3 grid grid-cols-2 gap-x-4 gap-y-3 animate-in fade-in slide-in-from-top-1 duration-200'>
                    ...
                    <div>
                      <div className='flex items-center justify-between text-[10px] text-gray-400 mb-1.5'>
                        ...
                        <span className='font-mono text-gray-600 dark:text-gray-300'>
                          {(
                            (selectedElement as any).hitboxWidth ||
                            (selectedElement.type === 'barcode' ? 30 : 10)
                          ).toFixed(0)}
                        </span>
                      </div>
                      <input
                    ...
                    <div>
                      <div className='flex items-center justify-between text-[10px] text-gray-400 mb-1.5'>
                        ...
                        <span className='font-mono text-gray-600 dark:text-gray-300'>
                          {(
                            (selectedElement as any).hitboxHeight ||
                            (selectedElement.type === 'barcode' ? 8 : 4)
                          ).toFixed(0)}
                        </span>
                      </div>
                      <input
