        ...
        {state.success ? (
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className={`w-full bg-zinc-900 border ${state.validationErrors.password ? 'border-red-500/50 focus:border-red-500' : 'border-zinc-800 focus:border-green-500/50'} rounded-lg px-4 py-3 text-sm text-white placeholder:text-zinc-600 outline-none transition-all duration-200 focus:ring-1 focus:ring-green-500/20 pr-10`}
                        />
                         <button
                            type="button"
            ...
            <div className="flex items-center justify-between">
                 ...
                 >
                    ...
                    <span className="text-xs text-zinc-500 group-hover:text-zinc-400">Remember for 30 days</span>
                 </button>
                 <span className="text-xs text-green-500 cursor-not-allowed opacity-50">Forgot password?</span>
            </div>
