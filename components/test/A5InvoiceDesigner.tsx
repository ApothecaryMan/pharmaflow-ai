...
export const A5InvoiceDesigner: React.FC<{ color?: string; t?: any; language: 'EN' | 'AR' }> = ({
  language,
}) => {
  // Designer States
  ...
  const [pharmacyName, setPharmacyName] = useState<string>(
    language === 'AR' ? 'صيدلية الشفاء الكبرى' : 'Al-Shifa Grand Pharmacy'
  );
  ...
  const supplier =
    EGYPTIAN_SUPPLIERS.find((s) => s.id === selectedSupplierId) || EGYPTIAN_SUPPLIERS[0];
  ...
  const handleAddItem = (e: React.FormEvent) => {
    ...
    const added: InvoiceItem = {
      ...
      publicPrice: Number(newItem.publicPrice) || 10.0,
      buyPrice: Number(newItem.buyPrice) || 8.0,
      discount: Number(newItem.discount) || 0,
      tax: Number(newItem.tax) || 14.0,
    };
  ...
  const fontSizeClass =
    fontSize === 'xs' ? 'text-[10px]' : fontSize === 'sm' ? 'text-[11px]' : 'text-xs';

  return (
    <div
      className='min-h-screen bg-zinc-50 dark:bg-[#282828] p-6 space-y-6 overflow-y-auto'
    ...
    >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 items-start'>
        ...
        <div className='lg:col-span-7 lg:sticky lg:top-24 flex flex-col items-center space-y-4'>
          ...
          <div className='w-full flex items-center justify-between bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl px-5 py-3 shadow-xs'>
            <div className='flex items-center gap-3'>
              ...
              <span className='text-xs font-bold text-zinc-650 dark:text-zinc-300'>
                {language === 'AR'
                  ? 'لوحة المعاينة التفاعلية المباشرة'
                  : 'Live High-Fidelity Paper Canvas'}
              </span>
            </div>
                        ...
                        >
                          <div>
                            ...
                            <div
                              ...
                              style={{
                                borderColor:
                                  orientation === 'landscape' ? accentColor : 'transparent',
                              }}
                            >
                              ...
                              <div
                                className={`flex items-start justify-between ${
                                  orientation === 'landscape'
                                    ...
                                    : 'border-b-2 pb-1.5 mb-1.5'
                                }`}
                                style={{
                                  borderColor:
                                    orientation === 'landscape' ? 'transparent' : accentColor,
                                }}
                              >
                                {/* Supplier info */}
                                ...
                                <div className='text-right space-y-1'>
                                  <span
                                    className='inline-block px-2 py-0.5 text-[8px] font-black text-white rounded'
                              ...
                              <div
                                className={`grid grid-cols-2 gap-3 bg-zinc-50 rounded-lg border border-zinc-200 text-[10px] ${
                              ...
                              >
                                <div className='space-y-1'>
                                  <p className='font-extrabold text-zinc-500 text-[8px] uppercase tracking-wider'>
                                    {language === 'AR'
                                      ? 'الجهة المستلمة (الصيدلية)'
                                      : 'Billed To (Pharmacy)'}
                                  </p>
                                  <p className='font-black text-zinc-900 text-xs'>{pharmacyName}</p>
                                  <p className='text-[9px] text-zinc-600 font-bold'>
                                    {language === 'AR'
                                      ? 'الرقم الضريبي الصيدلية:'
                                      : 'Pharmacy Tax ID:'}{' '}
                                    {pharmacyTaxId}
                                  </p>
                                </div>
                                <div className='space-y-1 text-right'>
                                  ...
                                  <p className='text-[9px] text-zinc-600 font-bold'>
                                    {language === 'AR' ? 'تاريخ التوريد:' : 'Supply Date:'}{' '}
                            ...
                            <div className='overflow-x-auto border border-zinc-200 rounded-lg'>
                              <table className='w-full text-left border-collapse'>
                                <thead>
                                  <tr
                                    className='bg-zinc-100 text-zinc-700 font-extrabold border-b border-zinc-200'
                                    style={{ fontSize: '9px' }}
                                  >
                                    <th className='p-1.5 text-center w-6 border-r border-zinc-200'>
                                      #
                                    </th>
                                    <th className='p-1.5 border-r border-zinc-200'>
                                      {language === 'AR'
                                        ? 'اسم الصنف الدوائي'
                                    ...
                                    {showBatchNumber && (
                                      <th className='p-1.5 text-center border-r border-zinc-200'>
                                        {language === 'AR' ? 'التشغيلة' : 'Batch'}
                                      </th>
                                    )}
                                    <th className='p-1.5 text-center border-r border-zinc-200'>
                                      {language === 'AR' ? 'الصلاحية' : 'Expiry'}
                                    </th>
                                    <th className='p-1.5 text-center border-r border-zinc-200'>
                                    ...
                                    <th className='p-1.5 text-right border-r border-zinc-200'>
                                      {language === 'AR' ? 'الجمهور' : 'Public'}
                                    </th>
                                    <th className='p-1.5 text-right border-r border-zinc-200'>
                                      {language === 'AR' ? 'الشراء' : 'Buy'}
                                    </th>
                                    <th className='p-1.5 text-center border-x border-zinc-200'>
                                ...
                                <tbody>
                                  {pageItems.map((item, idx) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        <td
                                          className={`p-1 text-center font-bold border-r border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle`}
                                        >
                                          {absoluteIdx + 1}
                                        </td>
                                        <td
                                          className={`p-1 border-r border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden align-middle`}
                                        >
                                          <div
                                            className={`font-extrabold text-[9px] text-zinc-950 line-clamp-2 leading-[10px] break-words ${
                                              orientation === 'portrait'
                                                ? 'max-w-[125px]'
                                                : 'max-w-[200px]'
                                            }`}
                                        ...
                                        {showBatchNumber && (
                                          <td
                                            className={`p-1 text-center font-mono text-[9px] text-zinc-650 border-r border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle truncate max-w-[50px]`}
                                          >
                                            {item.batch}
                                          </td>
                                        )}
                                        ...
                                        <td
                                          className={`p-1 text-center font-bold text-zinc-900 border-r border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle`}
                                        >
                                          {item.qty}
                                        </td>
                                        {showBonusColumn && (
                                          <td
                                            className={`p-1 text-center text-emerald-700 font-extrabold border-r border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle`}
                                          >
                                            {item.bonus > 0 ? `+${item.bonus}` : '0'}
                                          </td>
                                        )}
                                        <td
                                          className={`p-1 text-right font-mono text-zinc-650 border-r border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle`}
                                        >
                                          {item.publicPrice.toFixed(2)}
                                        </td>
                                        <td
                                          className={`p-1 text-right font-mono text-zinc-900 border-r border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle`}
                                        >
                                          {item.buyPrice.toFixed(2)}
                                        </td>
                                        <td
                                          className={`p-1 text-center font-bold text-amber-700 border-x border-zinc-200 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle`}
                                        >
                                          {item.discount > 0 ? `${item.discount}%` : '-'}
                                        </td>
                                        <td
                                          className={`p-1 text-right font-extrabold font-mono text-zinc-950 ${ROW_HEIGHT_CLASS} overflow-hidden whitespace-nowrap align-middle`}
                                        >
                                          {lineNet.toFixed(2)}
                                        </td>
                                      </tr>
                                  ...
                                  {pageItems.length === 0 && (
                                    <tr>
                                      <td
                                        colSpan={10}
                                        className='p-8 text-center text-zinc-400 font-bold text-xs'
                                      >
                                        {language === 'AR'
                                          ? 'لا توجد أصناف حالياً في فاتورة المشتريات'
                                          : 'No items added in the purchase invoice'}
                                      </td>
                                    </tr>
                                  )}
                                </tbody>
                          ...
                          <div>
                            {isLastPage ? (
                              <>
                                ...
                                <div
                                  className={`grid grid-cols-2 text-[10px] ${
                                    orientation === 'landscape' ? 'gap-2.5 mt-1.5' : 'gap-4 mt-3'
                                  }`}
                                >
                                  {/* Left Side: General Egyptian Terms and Notes */}
                                  <div
                                    className={`border border-zinc-200 rounded-lg bg-zinc-50/50 flex flex-col justify-between ${
                                      orientation === 'landscape'
                                        ? 'p-1.5 space-y-1'
                                        : 'p-2 space-y-1.5'
                                    }`}
                                  >
                                    <div>
                                      <p className='font-extrabold text-[8px] text-zinc-500 uppercase tracking-wider'>
                                        {language === 'AR'
                                          ? 'الشروط والملاحظات الضريبية'
                                          : 'Terms & Tax Declaration'}
                                      </p>
                                      <p
                                    ...
                                    {showDisclaimers && (
                                      <div
                                        className={`border-t border-dashed border-zinc-300 flex items-center gap-2 ${
                                          orientation === 'landscape' ? 'pt-0.5' : 'pt-1'
                                        }`}
                                      >
                                        <div
                                          className={`border border-zinc-300 dark:border-zinc-700 flex items-center justify-center font-mono font-bold text-zinc-400 shrink-0 ${
                                            orientation === 'landscape'
                                              ? 'w-9 h-9 text-[8px]'
                                              : 'w-12 h-12 text-[10px]'
                                          }`}
                                        ...
                                        <p
                                          className={`leading-tight text-zinc-400 ${
                                            orientation === 'landscape'
                                              ? 'text-[6.5px]'
                                              : 'text-[7px]'
                                          }`}
                                  ...
                                  <div
                                    className={`border border-zinc-200 rounded-lg overflow-hidden font-bold ${
                                  ...
                                  >
                                    ...
                                    >
                                      <span className='text-zinc-600'>
                                        {language === 'AR' ? 'إجمالي الجمهور:' : 'Total Public:'}
                                      </span>
                                      <span className='text-right font-mono font-extrabold'>
                                        {totals.totalPublic.toFixed(2)} EGP
                                      </span>
                                    </div>
                                    <div
                                      className={`grid grid-cols-2 border-b border-zinc-200 ${
                                    ...
                                    >
                                      <span className='text-zinc-600'>
                                        {language === 'AR' ? 'إجمالي سعر الشراء:' : 'Total Buying:'}
                                      </span>
                                      <span className='text-right font-mono font-extrabold'>
                                        {totals.totalBuy.toFixed(2)} EGP
                                      </span>
                                    </div>
                                    <div
                                      className={`grid grid-cols-2 border-b border-zinc-200 text-amber-700 bg-amber-50/40 ${
                                        orientation === 'landscape' ? 'p-1' : 'p-1.5'
                                      }`}
                                    >
                                      <span>
                                      ...
                                      <span className='text-right font-mono font-extrabold'>
                                        -{totals.totalDiscountVal.toFixed(2)} EGP
                                      </span>
                                    </div>
                                    <div
                                      className={`grid grid-cols-2 border-b border-zinc-200 text-zinc-600 ${
                                        orientation === 'landscape' ? 'p-1' : 'p-1.5'
                                      }`}
                                    >
                                      <span>
                                      ...
                                      <span className='text-right font-mono font-extrabold'>
                                        +{totals.totalTaxVal.toFixed(2)} EGP
                                      </span>
                                    </div>
                                    <div
                            ...
                            <div
                              className={`border-t border-dashed border-zinc-300 flex items-end justify-between select-none ${
                                orientation === 'landscape'
                            ...
                            >
                              ...
                              {showSignature && (
                                <div
                                  className={
                                    orientation === 'landscape' ? 'space-y-1' : 'space-y-2'
                                  }
                                >
                                  <p className='font-extrabold text-zinc-500'>
                                    {language === 'AR'
                                      ? 'المستلم (مدير الصيدلية):'
                                      : 'Receiver (Pharmacy Director):'}
                                  </p>
                                  <div
                              ...
                              {showStamp && (
                                <div className='flex flex-col items-center justify-center'>
                                  ...
                                  >
                                    ...
                                    <span
                                      className='scale-75 font-black tracking-tight leading-none'
                                      style={{
                                        fontSize: orientation === 'landscape' ? '4.5px' : '6px',
                                      }}
                                    >
                                      {stampSupplier}
                                    </span>
                                    <span
                                      className='border-t border-b border-dashed py-0.5 my-0.5 leading-none w-full'
                                      style={{
                                        fontSize: orientation === 'landscape' ? '5px' : '7px',
                                      }}
                                    >
                              ...
                              <div className='flex flex-col items-end gap-1 select-none'>
                                ...
                                <div className='flex flex-col items-center justify-center select-none pb-0.5'>
                                  ...
                                  <span className='text-[6px] tracking-widest text-zinc-450 font-mono block'>
                                    {barcodeNumber}
                                  </span>
                                </div>
                                ...
                                <div className='text-right space-y-0.5'>
                                  <p
                                    className={`text-zinc-400 font-extrabold ${
                                      orientation === 'landscape' ? 'text-[7.5px]' : 'text-[8px]'
                                    }`}
                                  >
                                    {language === 'AR'
                                      ? 'سلسلة الإمداد والخدمات الطبية'
                                      : 'Healthcare Supply Chain Co.'}
                                  </p>
                                  <p
                                  ...
                                  >
                                    {language === 'AR'
                                      ? 'مطبوع بواسطة: نظام فارما فلو الذكي'
                                      : 'Printed via PharmaFlow AI'}
                                  </p>
                                  <p
                                  ...
                                  >
                                    {language === 'AR' ? 'صفحة' : 'Page'} {pageIdx + 1}{' '}
                                    {language === 'AR' ? 'من' : 'of'} {pageChunks.length}
                                  </p>
                                </div>
                              </div>
                            </div>
          ...
          <div className='w-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 text-xs space-y-2.5'>
            <h4 className='font-extrabold text-zinc-805 dark:text-white flex items-center gap-2'>
              ...
              {language === 'AR'
                ? 'تعليمات طباعة A5 الاحترافية:'
                : 'Professional A5 Printing Guide:'}
            </h4>
            <ul className='list-disc list-inside space-y-1 text-zinc-550 dark:text-zinc-400 pl-2 leading-relaxed'>
              {language === 'AR' ? (
                <>
                  <li>
                    عند الضغط على زر <strong className='text-emerald-500'>اختبار الطباعة</strong>،
                    ستفتح لك شاشة المتصفح المخصصة للطباعة تلقائياً.
                  </li>
                  <li>
                    قم باختيار مقاس الورق{' '}
                    <strong className='text-zinc-900 dark:text-white font-black'>A5</strong> من
                    إعدادات الطابعة لتعبئة الورقة بالكامل.
                  </li>
                  <li>
                    تأكد من إلغاء خيار "الهوامش" (Margins: None) والـ "Headers and Footers" للحصول
                    على النسبة المثالية للمخازن.
                  </li>
                </>
              ) : (
                <>
                  <li>
                    Clicking <strong className='text-emerald-500'>Try Print A5</strong> invokes the
                    native system print workflow configured for this document.
                  </li>
                  <li>
                    Set the printer paper size to{' '}
                    <strong className='text-zinc-900 dark:text-white font-black'>A5</strong> in the
                    print settings dialog.
                  </li>
                  <li>
                    Recommended margins:{' '}
                    <strong className='text-zinc-900 dark:text-white font-black'>None</strong>, and
        ...
        <div className='lg:col-span-5 lg:h-[calc(100dvh-160px)] lg:overflow-y-auto lg:pr-3 space-y-6 pb-12'>
          ...
          <div className='bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm space-y-4'>
            <h3 className='font-black text-sm text-zinc-900 dark:text-white flex items-center gap-2 border-b border-[var(--border-divider)] pb-3'>
              <span className='material-symbols-rounded text-lg text-indigo-500'>
                settings_suggest
              </span>
              ...
              <div className='grid grid-cols-2 gap-3.5'>
                ...
                >
                  ...
                  <span className='text-[11px] font-extrabold'>
                    {language === 'AR' ? 'رقم التشغيلة (Batch)' : 'Batch Number'}
                  </span>
                </button>
                ...
                >
                  ...
                  <span className='text-[11px] font-extrabold'>
                    {language === 'AR' ? 'عمود البونص (+)' : 'Bonus Column'}
                  </span>
                </button>
                ...
                >
                  ...
                  <span className='text-[11px] font-extrabold'>
                    {language === 'AR' ? 'ختم الموزع المالي' : 'Corporate Stamp'}
                  </span>
                </button>
                ...
                >
                  ...
                  <span className='text-[11px] font-extrabold'>
                    {language === 'AR' ? 'توقيع المستلم' : 'Signature Box'}
                  </span>
                </button>
                ...
                >
                  ...
                  <span className='text-[11px] font-extrabold'>
                    {language === 'AR' ? 'الملاحظات والباركود' : 'Disclaimers'}
                  </span>
                </button>
              </div>
            </div>
          ...
          <div className='bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-sm space-y-4'>
            <h3 className='font-black text-sm text-zinc-900 dark:text-white flex items-center gap-2 border-b border-[var(--border-divider)] pb-3'>
              ...
              {language === 'AR'
                ? 'إدارة وحقن الأصناف الدوائية بالفاتورة'
            ...
            <form
              ...
              className='pt-3 border-t border-[var(--border-divider)] space-y-3'
            >
              ...
              <div className='grid grid-cols-2 gap-3'>
                ...
                <div className='space-y-1'>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewItem({ ...newItem, bonus: Math.max(0, Number(e.target.value)) })
                    }
                    className='w-full bg-zinc-50 dark:bg-[#1e1e1e] border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-1.5 text-xs text-zinc-900 dark:text-white focus:outline-none'
                  />
                </div>
              ...
              <div className='grid grid-cols-3 gap-3'>
                <div className='space-y-1'>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewItem({
                        ...newItem,
                        publicPrice: Math.max(0.01, Number(e.target.value)),
                      })
                    }
                    className='w-full bg-zinc-50 dark:bg-[#1e1e1e] border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-1.5 text-xs text-zinc-900 dark:text-white focus:outline-none'
                  />
                ...
                <div className='space-y-1'>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewItem({ ...newItem, buyPrice: Math.max(0.01, Number(e.target.value)) })
                    }
                    className='w-full bg-zinc-50 dark:bg-[#1e1e1e] border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-1.5 text-xs text-zinc-900 dark:text-white focus:outline-none'
                  />
                </div>
