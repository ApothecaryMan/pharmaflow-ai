...
export const SmallCard = ({
        ...
        <div className='space-y-1.5 pt-1'>
          ...
          {subValue && (
            <div className='flex items-center justify-between gap-4'>
              ...
              <span className='text-[10px] text-(--text-secondary) font-semibold truncate max-w-[80px]'>
                {subValue}
              </span>
            </div>
          )}
  ...
  return (
    <div
      className={`p-3 rounded-2xl ${CARD_BASE} ${CARD_HOVER} h-[84px] flex items-center gap-3 overflow-visible ${className}`}
    >
      {iconTooltip ? (
