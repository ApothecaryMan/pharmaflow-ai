    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Header */}
          {(title || type !== 'confirm') && (
            <div className={`px-3 py-1.5 flex items-center gap-1.5 border-b border-black/[0.04] dark:border-white/5 ${
              type === 'warning' ? 'bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400' : 
              ...
              {type === 'info' && (
                <span className="material-symbols-rounded text-blue-500" style={{ fontSize: '14px' }}>info</span>
              )}
