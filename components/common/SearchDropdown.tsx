...
export const SearchDropdown = <T extends { id: string | number }>({ 
    ...
    return (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-800 max-h-[400px] overflow-y-auto ring-1 ring-black/5 dark:ring-white/5 z-50 overflow-hidden" dir="ltr">
            {/* Header Row */}
