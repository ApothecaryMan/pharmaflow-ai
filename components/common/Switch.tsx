...
export const Switch: React.FC<SwitchProps> = ({
  ...
  if (variant === 'v1') {
    const bg =
      checked && !activeColor ? (theme === 'primary' ? 'bg-primary-600' : `bg-${theme}-600`) : '';
    return (
      <button
        {...commonProps}
        ref={ref}
      ...
      >
        ...
        >
          <svg
            className={`w-2.5 h-2.5 ${checked ? (activeColor ? '' : `text-${theme}-600`) : 'text-gray-400'}`}
  ...
  if (variant === 'ios') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s1-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  if (variant === 'minimal') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s3-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  if (variant === 'icon') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s4-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
        <svg
          className='s4-moon w-3.5 h-3.5'
          viewBox='0 0 24 24'
          fill='none'
          stroke='currentColor'
          strokeWidth='2'
  ...
  if (variant === 'vertical') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s5-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  if (variant === 'squircle') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s6-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  if (variant === 'slim') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s7-wrap ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  if (variant === 'outline') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s8-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  if (variant === 'segmented') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s9-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  if (variant === 'neon') {
    return (
      <div
        ...
        ref={ref}
        style={dynamicStyle}
        className={`s10-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
      >
  ...
  return (
    <div
      ...
      ref={ref}
      style={dynamicStyle}
      className={`s2-track ${checked ? 'on' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''} ${className}`}
    >
