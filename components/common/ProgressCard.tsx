    ...
    >
      <div className='flex items-center justify-between mb-2'>
        <div className='flex items-center gap-3'>
          <span
            className={`material-symbols-rounded text-3xl text-${progressColor}-500 dark:text-${progressColor}-400`}
          >
            {icon}
          </span>
          <div>
            ...
            <Tooltip content={`Total: ${max}`}>
              <h4 className='text-xl font-bold text-gray-900 dark:text-white leading-none mt-1'>
                {value}
              </h4>
            </Tooltip>
            ...
            {value2 && (
              <Tooltip content={`Total: ${max2}`} className='mt-0.5'>
                <p className='text-[10px] text-gray-400'>
                  {label2}:{' '}
                  <span className='font-semibold text-gray-700 dark:text-gray-300'>{value2}</span>
                </p>
              </Tooltip>
            )}
          </div>
    ...
    >
      ...
      <div className='flex-1 min-w-0 flex flex-col justify-center h-full'>
        ...
        <div className={`flex justify-between items-end ${compact ? 'mb-2' : 'mb-4'}`}>
          ...
          <h4
            className={`${compact ? 'text-xs font-bold' : 'text-sm font-bold'} text-gray-500 dark:text-gray-400 truncate ml-2`}
          >
            {title}
          </h4>
        </div>
