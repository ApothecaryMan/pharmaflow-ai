...
export const ExpandedModal: React.FC<ExpandedModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-4 animate-fade-in">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-6xl max-h-[95vh] bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-scale-in">
        {/* Header */}
        <div className={`flex items-center justify-between p-4 md:p-6 border-b border-slate-200 dark:border-slate-800 bg-${color}-50 dark:bg-${color}-950/20`}>
