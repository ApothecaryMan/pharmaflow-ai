      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td class="left">${sale.customerName ? sale.customerName : resolveCustomerName(sale, lang)}</td>
          </tr>
          ${
      ...
      <table>
        <thead>
          <tr>
            ...
            <th style="width: 15%;">${lang === 'AR' ? 'الكمية' : 'QTY'}</th>
            <th style="width: 25%;">${lang === 'AR' ? 'السعر' : 'PRICE'}</th>
          </tr>
        </thead>
        <tbody>
          ${(() => {
