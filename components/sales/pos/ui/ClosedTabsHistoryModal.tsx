      ...
      <div className='flex items-center justify-between w-full'>
        ...
        <div className='flex items-center gap-4 text-start'>
          <div className='flex flex-col items-start'>
            <h3
              className='font-bold text-gray-900 dark:text-gray-100 text-base leading-tight'
              dir='auto'
            >
              {tab.name}
              {tab.customerName && (
            ...
            content={
              <div className='min-w-[200px]'>
                <div className='text-[10px] font-black uppercase tracking-wider mb-2 border-b border-gray-200/50 dark:border-gray-800/50 pb-1 text-gray-500 flex items-center justify-between'>
                  <span>{cartTitle}</span>
                  <span className='text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 px-1.5 rounded'>
                    {tab.cart.length}
                  </span>
                </div>
                <ul
