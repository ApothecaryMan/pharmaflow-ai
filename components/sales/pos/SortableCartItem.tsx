    ...
    if (isLoading) {
      return (
        <div className='flex flex-col p-1.5 animate-pulse border-b border-gray-100 dark:border-gray-800/50 last:border-0 relative'>
          ...
          {/* <div className="absolute left-0 top-1.5 bottom-1.5 w-0.5 rounded-full bg-[var(--bg-skeleton)] opacity-50" /> */}

          <div className='flex flex-wrap items-center justify-between gap-x-1 gap-y-1 relative pl-2'>
            {/* Name Section */}
            <div className='flex-1 min-w-[120px]'>
              <div className='h-3 w-32 bg-[var(--bg-skeleton)] rounded-md' />
            </div>

            {/* Unified 'Rest' Section */}
            <div className='flex items-center gap-2 shrink-0 ml-auto'>
              {/* Expiry Placeholder */}
              <div className='h-5 w-14 bg-[var(--bg-skeleton)] opacity-60 rounded-full' />

              {/* Discount Placeholder */}
              <div className='h-5 w-10 bg-[var(--bg-skeleton)] opacity-60 rounded-full' />

              {/* Qty Control Placeholder */}
              <div className='h-7 w-20 bg-[var(--bg-skeleton)] rounded-xl' />

              {/* Price Placeholder */}
              <div className='h-3 w-14 bg-[var(--bg-skeleton)] rounded-md' />
      ...
      `} /> */}
        ...
        <div className='flex flex-wrap items-center justify-between gap-x-1 gap-y-1 relative pl-2'>
          ...
          <div className='flex items-center gap-1 shrink-0 ml-auto'>
            ...
            <div
              className='text-xs font-bold text-gray-900 dark:text-white shrink-0 text-end tabular-nums w-[4rem] overflow-hidden text-ellipsis'
              dir='ltr'
