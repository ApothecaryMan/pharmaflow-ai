    ...
    <svg viewBox='0 0 128 128' fill='none' overflow='visible' className='w-full h-full'>
      <g opacity='0.95'>
        ...
        <g transform='translate(64, 10)'>
          <path
            d='M0,10 C-10,3 -14,-7 -7,-11 C-2,-14 0,-6 0,-6 C0,-6 2,-14 7,-11 C14,-7 10,3 0,10 Z'
            fill='#98002E'
            opacity='0.4'
        ...
        <g transform='translate(32, 21) rotate(-35)'>
          <path
            d='M0,7 C-7,2 -10,-5 -5,-8 C-1,-10 0,-4 0,-4 C0,-4 1,-10 5,-8 C10,-5 7,2 0,7 Z'
            fill='var(--svg-color, #FF4D6D)'
            stroke='#98002E'
            strokeWidth='0.8'
          />
        ...
        <g transform='translate(14, 43) rotate(-65)'>
          <path
            d='M0,6 C-6,2 -8,-4 -4,-7 C-1,-9 0,-3 0,-3 C0,-3 1,-9 4,-7 C8,-4 6,2 0,6 Z'
            fill='var(--svg-color, #FF4D6D)'
            stroke='#98002E'
            strokeWidth='0.7'
          />
        ...
        <g transform='translate(8, 64) rotate(-90)'>
          <path
            d='M0,9 C-9,3 -12,-6 -6,-10 C-2,-12 0,-5 0,-5 C0,-5 2,-12 6,-10 C12,-6 9,3 0,9 Z'
            fill='var(--svg-color, #FF4D6D)'
            stroke='#98002E'
            strokeWidth='0.9'
          />
