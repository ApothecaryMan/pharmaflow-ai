  ...
  return (
    <svg viewBox='0 0 128 128' fill='none' overflow='visible' className='w-full h-full'>
      <g opacity='0.98'>
        ...
        <circle cx='64' cy='64' r='54' stroke='var(--svg-color, #F59E0B)' strokeWidth='1' strokeDasharray='1 5' opacity='0.7' />

        <circle cx='64' cy='64' r='58' stroke='#06B6D4' strokeWidth='1.2' strokeDasharray='40 80 60 30' strokeLinecap='round' opacity='0.6' />
        <circle cx='64' cy='64' r='51' stroke='#7C3AED' strokeWidth='0.8' strokeDasharray='10 15 30 10' opacity='0.5' />

        <g transform='translate(64, 12)'>
          <circle cx='0' cy='0' r='8' fill='var(--svg-color, #F59E0B)' opacity='0.15' filter='blur(1px)' />
        ...
        <g transform='translate(11, 52) rotate(-15)'>
          <polygon points='0,-22 -5,4 0,12 5,4' fill='#2E1065' opacity='0.4' transform='translate(1, 2)' />
        ...
        <path d='M114,96 Q114,98 112,98 Q114,98 114,100 Q114,98 116,98 Q114,98 114,96 Z' fill='#06B6D4' />
        ...
        <circle cx='64' cy='118' r='1.5' fill='var(--svg-color, #F59E0B)' stroke='#78350F' strokeWidth='0.5' />
