...
export const AVATAR_DECORATIONS: DecorationDef[] = [
  ...
  // --- Wings (أجنحة) ---
  { id: 'angel_wings', name: 'Angel Wings', nameAr: 'أجنحة الملاك', svg: <AngelWings />, isAnimated: true },
  { id: 'fairy_wings', name: 'Fairy Wings', nameAr: 'أجنحة الجنية', svg: <FairyWings /> },
  { id: 'dragon_wings', name: 'Dragon Wings', nameAr: 'أجنحة التنين', svg: <DragonWings />, isAnimated: true },
  ...
  { id: 'neon_cosmic_vortex', name: 'Cosmic Vortex', nameAr: 'دوامة المجرة', svg: <NeonCosmicVortex />, isAnimated: true },
  { id: 'stellar_constellations', name: 'Stellar Constellation', nameAr: 'الكوكبة الفلكية', svg: <StellarConstellations />, isAnimated: true },
  { id: 'ethereal_heaven_vortex', name: 'Ethereal Heaven', nameAr: 'الفردوس الأثيري المضيء', svg: <EtherealHeavenVortex />, isAnimated: true },
  { id: 'ultimate_chronogear_nexus', name: 'Chronogear Nexus', nameAr: 'آلة الزمن السحرية', svg: <UltimateChronogearNexus />, isAnimated: true },
  { id: 'galactic_black_hole', name: 'Galactic Black Hole', nameAr: 'الثقب الأسود المجري', svg: <GalacticBlackHole />, isAnimated: true },
  { id: 'neon_cyber_hex', name: 'Neon Cyber Hex', nameAr: 'مصفوفة السايبر-بانك السداسية', svg: <NeonCyberHex />, isAnimated: true },
  { id: 'arcane_magic_runes', name: 'Arcane Magic Runes', nameAr: 'حلقات السحر الرونية', svg: <ArcaneMagicRunes />, isAnimated: true },
  { id: 'ethereal_spirit_dragons', name: 'Ethereal Spirit Dragons', nameAr: 'تنانين الروح الأثيرية', svg: <EtherealSpiritDragons />, isAnimated: true },
  { id: 'divine_radiant_sun', name: 'Divine Radiant Sun', nameAr: 'شمس الإشعاع الإلهي', svg: <DivineRadiantSun />, isAnimated: true },
  { id: 'genius_geometric_matrix', name: 'Genius Matrix', nameAr: 'مصفوفة العبقرية الهندسية', svg: <GeniusGeometricMatrix />, isAnimated: true },
  { id: 'cryo_vapor_nexus', name: 'Cryo-Vapor Nexus', nameAr: 'رابطة الجليد والبخار', svg: <CryoVaporNexus />, isAnimated: true },
  { id: 'ultra_rainbow_aura', name: 'Ultra Rainbow Aura', nameAr: 'هالة قوس قزح الخارقة', svg: <UltraRainbowAura />, isAnimated: true },
];
