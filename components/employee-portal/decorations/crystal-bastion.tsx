export function CrystalBastion() {
  return (
    <svg viewBox='0 0 128 128' fill='none' overflow='visible' className='w-full h-full'>
      <g opacity='0.98'>
        <circle cx='64' cy='64' r='54' stroke='var(--svg-color, #00F0FF)' strokeWidth='1' opacity='0.2' />
        <circle cx='64' cy='64' r='51' stroke='#6366F1' strokeWidth='0.6' strokeDasharray='4 8' opacity='0.4' />
        <path d='M 14,40 L 114,88 M 14,88 L 114,40' stroke='var(--svg-color, #00F0FF)' strokeWidth='0.4' opacity='0.15' />
        <path d='M 40,14 L 88,114 M 48,114 L 88,14' stroke='var(--svg-color, #00F0FF)' strokeWidth='0.4' opacity='0.15' />
        ...
        <path d='M27,64 Q27,67 24,67 Q27,67 27,70 Q27,67 30,67 Q27,67 27,64 Z' fill='var(--svg-color, #00F0FF)' />
        <path d='M101,64 Q101,67 98,67 Q101,67 101,70 Q101,67 104,67 Q101,67 101,64 Z' fill='var(--svg-color, #00F0FF)' />
