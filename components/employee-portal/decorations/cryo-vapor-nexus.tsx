    ...
    <svg viewBox='0 0 128 128' fill='none' overflow='visible' className='w-full h-full'>
      ...
      <g opacity='0.95'>
        ...
        <g className='cvn-origin cvn-water'>
          <circle cx='62' cy='64' r='53' stroke='#0284c7' strokeWidth='1.5' fill='none' opacity='0.7' className='cvn-origin cvn-spin-slow' />
          <circle cx='66' cy='62' r='55' stroke='#0ea5e9' strokeWidth='2' fill='none' opacity='0.8' className='cvn-origin cvn-spin-fast' />
          <circle cx='64' cy='66' r='54' stroke='#38bdf8' strokeWidth='1.5' fill='none' opacity='0.6' className='cvn-origin cvn-spin-slow' style={{ animationDirection: 'reverse' }} />
          <circle cx='63' cy='63' r='56' stroke='#7dd3fc' strokeWidth='2.5' strokeDasharray='20 30 10 40' fill='none' opacity='0.9' className='cvn-origin cvn-spin-fast' />
        </g>
        ...
        <g className='cvn-origin cvn-spin-cw' style={{ animationDuration: '60s' }}>
          ...
          <g className='cvn-origin cvn-spin-ccw' style={{ animationDuration: '45s' }}>
            {steamOrbs.map((orb, i) => (
              <circle 
                key={`steam2-${i}`} 
                cx={128 - orb.x} cy={128 - orb.y} r={orb.size * 1.2} 
                fill='#ffffff' 
                filter="url(#cvn-steam-blur)"
                className='cvn-origin cvn-steam'
        ...
        <g className='cvn-origin cvn-spin-slow'>
          ...
          <circle cx='64' cy='64' r='59' stroke='#bae6fd' strokeWidth='0.5' strokeDasharray='1 6' fill='none' opacity='0.8' />
          <circle cx='64' cy='64' r='58' stroke='#e0f2fe' strokeWidth='1' strokeDasharray='4 12' fill='none' opacity='0.5' />
          ...
          {iceCrystals.map((c) => (
            ...
            >
              ...
              {c.isMajor && (
                <polygon points="0,-8 2,0 0,10 -2,0" fill="#ffffff" opacity="0.8" />
              )}
            </g>
          ))}
        </g>
