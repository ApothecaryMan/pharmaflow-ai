      ...
      <g opacity='0.85'>
        ...
        <g className='ch-ring'>
          <circle
            ...
            stroke='#06b6d4'
            strokeWidth='1'
            strokeDasharray='10 15 30 5 5 20'
            opacity='0.7'
          />
          <circle
            cx='64'
          ...
          />
          <path
            d='M64,2 L64,8 M64,120 L64,126 M2,64 L8,64 M120,64 L126,64'
            stroke='#22d3ee'
            strokeWidth='2'
          />
        </g>
        ...
        <g stroke='#22d3ee' strokeWidth='1' fill='none' opacity='0.6'>
          ...
          <polygon
            points='98,90 108,84 118,90 118,102 108,108 98,102'
            className='ch-hex-2'
            stroke='#d946ef'
          />
          <polygon points='10,70 20,64 30,70 30,82 20,88 10,82' className='ch-hex-3' />
          <polygon
            points='80,15 90,9 100,15 100,27 90,33 80,27'
            className='ch-hex-1'
            stroke='#d946ef'
          />
        </g>
