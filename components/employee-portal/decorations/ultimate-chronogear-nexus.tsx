    ...
    <svg viewBox='0 0 128 128' fill='none' overflow='visible' className='w-full h-full'>
      ...
      <defs>
        <g id='magic-cog'>
          ...
          <path d='M-9,0 L9,0 M0,-9 L0,9 M-6.3,-6.3 L6.3,6.3 M-6.3,6.3 L6.3,-6.3' stroke='#D97706' strokeWidth='1' />
      ...
      <g opacity='0.98'>
        <circle cx='64' cy='64' r='54' stroke='var(--svg-color, #06B6D4)' strokeWidth='2' opacity='0.4' className='power-glow center-org' />
        ...
        <g className='center-org gear-slow' stroke='#67E8F9' strokeWidth='1' strokeLinecap='round' opacity='0.9'>
        ...
        <g className='center-org time-sweep'>
          <path d='M 64,4 A 60,60 0 0,1 124,64' stroke='var(--svg-color, #06B6D4)' strokeWidth='1' fill='none' strokeLinecap='round' opacity='0.4' />
          <path d='M 64,4 A 60,60 0 0,1 94,14' stroke='#22D3EE' strokeWidth='2.5' fill='none' strokeLinecap='round' />
          <path d='M 64,4 A 60,60 0 0,1 78,6' stroke='#FFF' strokeWidth='4' fill='none' strokeLinecap='round' />
