export function OverlordChaosHorns() {
  return (
    <svg viewBox='0 0 128 128' fill='none' overflow='visible' className='w-full h-full'>
      <title>Overlord chaos horns</title>
      <g opacity='0.98'>
        ...
        <g transform='translate(-10, -24)'>
          ...
          />
          <path
            d='M117,21 Q111,24 108,18'
            stroke='#450A0A'
            strokeWidth='1.5'
            strokeLinecap='round'
          />
          <path
            d='M121,12 Q115,15 112,9'
            stroke='#450A0A'
            strokeWidth='1.5'
            strokeLinecap='round'
          />
          <path
            d='M123,2  Q118,4  116,-1'
            stroke='#450A0A'
            strokeWidth='1.2'
            strokeLinecap='round'
          />
