  ...
  return (
    <svg viewBox='0 16 128 128' fill='none' overflow='visible' className='w-full h-full'>
      ...
      <g className='ice-tiara-group' opacity='0.3' filter='blur(2px)'>
        <path
          d='M 18,38 Q 64,24 110,38 L 116,20 L 88,14 L 64,2 L 40,14 L 12,20 Z'
          fill='var(--svg-color, #38BDF8)'
        />
      </g>
      ...
      <g className='ice-tiara-group'>
        ...
        <path
          d='M14,22 Q26,24 40,12 Q52,22 64,2 Q76,22 88,12 Q102,24 114,22'
          stroke='#E0F2FE'
          strokeWidth='0.8'
          opacity='0.95'
          fill='none'
        />
        <path
          d='M18,37 Q41,33 64,32 Q87,33 110,37'
          stroke='#FFFFFF'
          strokeWidth='0.6'
          opacity='0.8'
          fill='none'
      ...
      <g className='shimmering-frost'>
        ...
        <g transform='translate(114, 46)'>
          <polygon
            points='0,-6 -3,0 0,6 3,0'
            fill='var(--svg-color, #38BDF8)'
            className='pulsing-shard'
          />
        </g>
        ...
        <path
          d='M64,44 Q64,46 62,46 Q64,46 64,48 Q64,46 66,46 Q64,46 64,44 Z'
          fill='var(--svg-color, #38BDF8)'
        />
