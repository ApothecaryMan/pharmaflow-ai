...
const DocCard: React.FC<DocCardProps> = ({ title, image, onUpload, onRemove, isExpanded, onToggleExpand, loading, deleting, isLoadingDocs, t }) => {
...
export const DocumentsTab: React.FC<DocumentsTabProps> = ({ profile, t, onUpdateProfile, cachedDocs, setCachedDocs }) => {
