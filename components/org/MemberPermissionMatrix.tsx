  ...
  const columns = React.useMemo<ColumnDef<Employee>[]>(
    () => [
        ...
        cell: (info) => {
          ...
          return (
            <div className='flex flex-col py-1'>
              ...
              <span className='text-xs text-zinc-500 font-mono tracking-tighter opacity-70'>
      ...
      },
      {
        ...
        meta: { align: 'start' },
        cell: (info) => (
          <span className='text-sm text-zinc-600 dark:text-zinc-400 font-mono tracking-tight'>
