...
export const TRANSLATIONS = {
  EN: {
    ...
    shortages: {
      ...
      statusOutOfStockSold: 'Out of Stock (Sold Recently)',
      statusManualMinimumReached: 'Below Manual Limit',
      statusPredictiveShortage: 'Predictive Shortage (AI)',
      statusOutOfStockDefault: 'Out of Stock (Inactive)',
      statusNormal: 'Normal',
  ...
  AR: {
    ...
    shortages: {
      ...
      statusOutOfStockSold: 'نفد بالكامل (بيع مؤخراً)',
      statusManualMinimumReached: 'تجاوز الحد الأدنى اليدوي',
      statusPredictiveShortage: 'نفاد متوقع',
      statusOutOfStockDefault: 'نفد بالكامل (غير نشط)',
      statusNormal: 'طبيعي',
