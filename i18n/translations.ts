...
export const TRANSLATIONS = {
  EN: {
    ...
    printerSettings: {
      ...
      subtitle: 'Manage printers for silent printing',
      detectPrinter: 'Detect New Printer',
      ...
      printTestSuccess: 'Test print sent successfully',
      printTestFailed: 'Test print failed',
      webUSBNotSupported: 'WebUSB is not supported in this browser. Please use Chrome or Edge.',
      permissionDenied: 'Printer access was denied',
  ...
  AR: {
    ...
    printerSettings: {
      ...
      subtitle: 'إدارة الطابعات للطباعة الصامتة',
      detectPrinter: 'اكتشاف طابعة جديدة',
      connectedPrinters: 'الطابعات المتصلة',
      noPrinters: 'لم يتم اكتشاف طابعات',
      ...
      printTestSuccess: 'تم إرسال طباعة الاختبار بنجاح',
      printTestFailed: 'فشل طباعة الاختبار',
      webUSBNotSupported: 'WebUSB غير مدعوم في هذا المتصفح. يرجى استخدام Chrome أو Edge.',
      permissionDenied: 'تم رفض الوصول للطابعة',
      selectPrinter: 'اختر طابعة',
      printerInfo: 'معلومات الطابعة',
      vendorId: 'رقم المصنع',
