...
export const TRANSLATIONS = {
  EN: {
    ...
    settings: {
      ...
      designStyle: 'Design Style (Navbar & Sidebar)',
    ...
    inventory: {
      ...
      addProduct: {
        ...
        placeholders: {
          ...
          activeIngredients: 'e.g., Paracetamol 500mg, Caffeine 30mg',
  ...
  AR: {
    ...
    settings: {
      ...
      designStyle: 'نمط التصميم (الشريط العلوي والجانبي)',
    ...
    inventory: {
      ...
      addProduct: {
        ...
        fields: {
          ...
          origin: 'منشأ المنتج',
          activeIngredients: 'المواد الفعلة / التركيب',
          description: 'الوصف',
        ...
        placeholders: {
          ...
          activeIngredients: 'مثال: باراسيتامول ٥٠٠ مجم، كافيين ٣٠ مجم',
